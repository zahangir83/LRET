...
from wsi_utils import wsi_inference_GLR as wsi_inf
...
parser.add_argument('--project_name_classification', type=str, default="74CLS_LR_ResNet50_4A100GPUs_final_101723", help='Name of your project')
...
# >>>>>>>>>>>>>>>>>>>>>>>>>> GBM_TCIA <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
#parser.add_argument('--input_svs_image_path', type=str, default="/home/malom/stjude_projects/computational_pathology/Large_scale_histopathology_analysis/database/74_clas_DB/test_TCIA_UPENN_GBM/GBM_TCIA/", help='Dataset you are using.')
...
#WSIs_and_patche_dir = '/home/malom/stjude_projects/computational_pathology/Large_scale_histopathology_analysis/experimental_logs/74CLS_Path_ResNet50_2GPUs_final/testing/TCGA_GBM_LGG_SVS_files_ouptuts/'
#WSIs_and_patche_dir = '/home/malom/stjude_projects/computational_pathology/Large_scale_histopathology_analysis/experimental_logs/74CLS_Path_ResNet50_2GPUs_final/testing/LGG_ouptuts/'
WSIs_and_patche_dir = '/home/malom/stjude_projects/computational_pathology/Large_scale_histopathology_analysis/experimental_logs/74CLS_Path_ResNet50_2GPUs_final/testing/GBM_ouptuts/'
...
for kk in range(num_wsi):
    ...
    merged_testing_log_saving_path_final = os.path.join(testing_log_saving_path_final,directory_names_all[kk]+'_outputs')
    ...
    class_log_dir = os.path.join(testing_log_saving_path_final,directory_names_all[kk])
    df_matrix_unquelb_counts_indv_case = wsi_utils_functions.patches_to_image_from_prediction_draw_ROI_WSI_for_BT74class_final_cv2_patches_outputs_diff_dir(WSIs_and_patche_dir_final, class_log_dir, Threshold, merged_testing_log_saving_path_final)
...
df_outputs_final.to_csv(os.path.join(testing_log_saving_path_final,proj_outputs_name_final+'_'+str(Threshold)+'_'+str(len(caseID_final))+'.csv'))

#df_outputs_final.to_csv(os.path.join(testing_log_saving_path_final,proj_outputs_name_final+'_'+str(Threshold)+'_119'+'.csv'))
