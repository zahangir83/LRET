...
parser.add_argument('--project_name', type=str, default="74CLS_LR_ResNet50_4A100GPUs_final_101723", help='Name of your project')
...
parser.add_argument('--dataset_path_test', type=str, default="/scratch_space/malom/project_74_classes/db_final_20K_final/test/", help='Dataset you are using.')
