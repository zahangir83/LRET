...
parser.add_argument('--project_name', type=str, default="74CLS_Path_DenseNet121_AVGP_4A100GPUs_final", help='Name of your project')
...
with strategy.scope():
    ...
    model = PathNet_TF_V1.get_Path_DenseNet121_model(INP_SIZE, num_feature_maps, num_classes)
