...
parser.add_argument('--project_name', type=str, default="74CLS_Path_ResNet50_2GPUs_final", help='Name of your project')
...
parser.add_argument('--input_height', type=int, default=2048, help='Height of cropped input image to network')
parser.add_argument('--input_width', type=int, default=2038, help='Width of cropped input image to network')
...
with strategy.scope():
    ...
    model = PathNet_TF_V1.get_Path_ResNet50_model(INP_SIZE, num_classes)
