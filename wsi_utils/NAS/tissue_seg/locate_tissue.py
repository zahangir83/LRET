...
def locate_tissue_cnts(slide_path,
    ...
    im_PIL = Image.fromarray(slide_img)
    ...
    bw_remove_PIL = Image.fromarray(bw_remove)
    bw_remove_PIL.save(final_bimg_des)
    ...
    final_ctimg_des_PIL = Image.fromarray(slide_img)
    final_ctimg_des_PIL.save(final_ctimg_des)
