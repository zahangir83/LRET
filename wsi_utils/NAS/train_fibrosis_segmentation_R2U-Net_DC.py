...
parser.add_argument('--project_name', type=str, default="fibrosis_seg_R2U_Net_DC_MDB_PIL", help='Name of your project')
...
# Public dataset......
#parser.add_argument('--dataset_path', type=str, default="/home/mza/Desktop/NASH_score_public_dataset/Fibrosis_segm_project/database/images_masks_selected/", help='Dataset you are using.')
# MEDPACE dataset......
parser.add_argument('--dataset_path', type=str, default="/home/mza/Desktop/NASH_score_public_dataset/Testing_WSI_from_MedPace/Fibrosis_detection/PIL_patches_masks_1024_and_256/images_masks_256/", help='Dataset you are using.')
...
ac_x_data,gray_x_data,y_data = dataset_utils.read_images_and_masks_for_fibrosis_seg(args.dataset_path,args.crop_height, args.crop_width)
x_data = ac_x_data
x_data,y_data,mean,std = dataset_utils.samples_normalization (x_data, y_data)



mean_saving_dir = training_log_saving_path+'fibrosis_mean.npy'
std_saving_dir = training_log_saving_path+'fibrosis_std.npy'
