...
parser.add_argument('--project_name', type=str, default="74CLS_Path_ResNet50_2GPUs_HPC_testing", help='Name of your project')
...
with strategy.scope():
    ...
    #model = PathNet_TF_V1.get_Path_ResNet50_model(INP_SIZE, num_feature_maps, num_classes)
    
    model = PathNet_TF_V1.PathNet_RESNET50(INP_SIZE, num_classes)
