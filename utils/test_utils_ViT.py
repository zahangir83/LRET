...
def loading_images_from_dir(image_directory,target_size):
    
    # List to store the loaded images
    images = []
    # Loop through the directory and load each PNG image
...
def class_activation_heatmap_of_feature_from_dirs_save_diff_dirs_ViT(scr_dir, model, feature_number, image_size, save_dir):
    '''
