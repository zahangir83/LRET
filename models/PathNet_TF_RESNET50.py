...
from tensorflow.keras.layers import GlobalMaxPooling2D, Activation, Conv2D, MaxPooling2D, BatchNormalization
from tensorflow.keras.layers import AveragePooling2D, Reshape, Permute, multiply
