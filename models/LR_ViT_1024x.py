...
def get_model_ViT_classifier_v2(INP_SIZE, input_patch_size, num_classes):
    #inputs = layers.Input(shape=input_shape)
    # Augment data.
    #augmented = data_augmentation(inputs)
...
def get_model_LR_with_ViT_classifier(INP_SIZE, learnable_resizer, num_classes):
...
def get_model_LR_with_ViT_classifier_v2(INP_SIZE, input_patch_size, learnable_resizer, num_classes):
